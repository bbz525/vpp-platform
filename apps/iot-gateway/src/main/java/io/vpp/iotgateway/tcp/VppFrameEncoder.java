...
public class VppFrameEncoder extends MessageToMessageEncoder<VppFrame> {
    private static final int MAGIC = 0x56505031;

    @Override
    protected void encode(ChannelHandlerContext context, VppFrame frame, List<Object> output) {
